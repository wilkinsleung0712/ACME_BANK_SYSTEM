 ...
 */
public class RDBSavingsAccountDAO implements SavingsAccountDAO{
private  Connection dbConnection=null;
private final String SQL_CREATE_SAVINGS="INSERT INTO ACME_BANK.SAVINGS(ACCNUM, C_ID, BALANCE)"+ " VALUES (?, ?, ?)";
...
private final String SQL_SET_BALANCE="UPDATE  ACME_BANK.SAVINGS SET BALANCE=? WHERE C_ID=?";
    ...
    public RDBSavingsAccountDAO(Connection dbConnection) {
    ...
    try {
        SavingsAccount account=new SavingsAccount(C_ID);
        
        PreparedStatement prestmnt=dbConnection.prepareStatement(SQL_CREATE_SAVINGS);
        
        prestmnt.setString(1, account.getAccNum());
        prestmnt.setInt(2, account.getC_ID());
        prestmnt.setInt(3, account.getBalance());
